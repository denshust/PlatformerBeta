...
mudimg = new Image(size, size), iceimg = new Image(size, size), wallimg = new Image(size, size), duckimg = new Image(size, size), enemyimg = new Image(size, size), cat = new Image;
